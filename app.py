...
defis = [
    {"titre": "Précision Optique", "texte": "Décontamination immédiate des verres ! Buvez autant de gorgées qu'il y a de binoclards autour de la table.", "stade": "Filtration", "icone": "👓"},
